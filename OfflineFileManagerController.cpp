...
#include "MaximumReadingDepthDialog.h"
...
{
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionSaveToFile, this, &OfflineFileManagerController::saveModelToFile);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionLoadFromFile, this, &OfflineFileManagerController::loadModelFromFile);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionUpdate, this, &OfflineFileManagerController::update);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionGoUpper, this, &OfflineFileManagerController::goUpper);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionGoHome, this, &OfflineFileManagerController::goHome);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionAddFolder, this, &OfflineFileManagerController::addFolder);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionSearch, this, &OfflineFileManagerController::search);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionOpenRobocopy, this, &OfflineFileManagerController::openRobocopyTool);

    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionExternalDrivesRegime, this, &OfflineFileManagerController::setExternalDrivesMode);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionAllDrivesRegime, this, &OfflineFileManagerController::setAllDrivesMode);
    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionGoogleDriveRegime, this, &OfflineFileManagerController::setGoogleDriveMode);

    connect(&view->actionsSignals, &OfflineFileManagerViewActions::actionSetMaxReadingDepth, this, &OfflineFileManagerController::setMaximumReadingDepth);

    connect(&view->treeSignals, &OfflineFileManagerViewTree::onTreeWidgetClicked, view, &OfflineFileManagerView::highlightItem);
    connect(&view->treeSignals, &OfflineFileManagerViewTree::onTreeWidgetDoubleClicked, view, &OfflineFileManagerView::expandFolder);
    connect(&view->treeSignals, &OfflineFileManagerViewTree::onCustomContextMenuRequested, this, &OfflineFileManagerController::openCustomContextMenu);

    connect(&view->buttonsSignals, &OfflineFileManagerViewButtons::onUpdateButtonClicked, this, &OfflineFileManagerController::update);
    connect(&view->buttonsSignals, &OfflineFileManagerViewButtons::onUpButtonClicked, this, &OfflineFileManagerController::goUpper);
    connect(&view->buttonsSignals, &OfflineFileManagerViewButtons::onHomeButtonClicked, this, &OfflineFileManagerController::goHome);
    connect(&view->buttonsSignals, &OfflineFileManagerViewButtons::onAddFolderButtonClicked, this, &OfflineFileManagerController::addFolder);
    connect(&view->buttonsSignals, &OfflineFileManagerViewButtons::onSearchButtonClicked, this, &OfflineFileManagerController::search);
    connect(view, &OfflineFileManagerView::close, this, &OfflineFileManagerController::alertUser);

    connect(view, &OfflineFileManagerView::onEditLineEditingFinished, this, &OfflineFileManagerController::editLineChanged);

    connect(this, &OfflineFileManagerController::save, model, &QFileInfoModel::readFile);
    connect(this, &OfflineFileManagerController::load, model, &QFileInfoModel::writeFile);

    connect(model, &QFileInfoModel::loaded, view, &OfflineFileManagerView::update);
}

void manager::OfflineFileManagerController::saveModelToFile()
{
...
{
    QString path = view->getEditLineText();
    QModelIndex index = model->byPath(path);

    view->rollUpFolder(index);

    QStringList newPath = model->getPath(index.parent());
    QString spath;
    foreach (auto file, newPath)
    {
        file.removeIf([](QChar c)
                      { return c == QChar('/') || c == QChar('\\'); });
        spath += '/' + file;
    };

    view->setEditLineText(spath);
}
